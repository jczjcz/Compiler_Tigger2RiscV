...
.PHONY: lc
lc:
	lex -o $(BUILD_DIR)/xcw_main.l.yy.cpp $(SOURCE_DIR)/riscv_scanner.l
	yacc -v --defines=$(BUILD_DIR)/xcw_parser.tab.h --output=$(BUILD_DIR)/xcw_parser.tab.c $(SOURCE_DIR)/riscv_parser.y
